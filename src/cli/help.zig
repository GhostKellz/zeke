...
/// Enhanced help system with colors and examples
pub const Help = struct {
    ...
    fn printHeader(self: Help, writer: anytype) !void {
        if (self.use_color) {
            try writer.print("{s}⚡ ZEKE{s} v0.3.0 - The Zig-Native AI Dev Companion\n", .{ Color.bold ++ Color.cyan, Color.reset });
        } else {
            try writer.writeAll("ZEKE v0.3.0 - The Zig-Native AI Dev Companion\n");
        }
    }
